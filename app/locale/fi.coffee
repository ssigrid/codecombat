...
#    become_investor: "to become an investor in CodeCombat"
    ...
    built_for_teachers_subblurb2: "Oppijat rakentavat sokkeloita ja hyödyntävät syötteen käsittelyn perustaitoja ohjelmoidessaan omia pelejä jaettavaksi ystävien ja perheenjäsenten kanssa."
    built_for_teachers_subtitle3: "Web-kehitys"
    built_for_teachers_subblurb3: "Oppijat kehittävät mielikuvitustaan käyttäen HTML:ää, CSS:ää ja jQuerya omien nettisivujensa ohjelmointiin. Yksilöllinen URL mahdollistaa omien sivujen jakamisen myös luokkakavereille."
...
#    century_skills_quote1: "You mess up…so then you think about all of the possible ways to fix it, and then try again. I wouldn't be able to get here without trying hard."
    century_skills_subtitle1: "Kriittinen ajattelu"
#    century_skills_subblurb1: "With coding puzzles that are naturally scaffolded into increasingly challenging levels, CodeCombat's programming game ensures kids are always practicing critical thinking."
    century_skills_quote2: "Kaikki muut keskittyivät sokkeloiden tekemiseen, joten ajattelin ´nyt nappaan lipun´ja tein sen."
    century_skills_subtitle2: "Luovuus"
    century_skills_subblurb2: "CodeCombat rohkaisee oppijoita näyttämään luovuuttaan omien pelien sekä nettisivujen luomisessa ja jakamisessa."
    century_skills_quote3: "Jos jään jumiin jollekin tasolle, teen yhteistyötä muiden kanssa kunnes löydämme yhdessä ratkaisun."
    century_skills_subtitle3: "Yhteistyö"
